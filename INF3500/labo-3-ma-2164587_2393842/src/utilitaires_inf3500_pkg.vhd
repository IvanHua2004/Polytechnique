...
package body utilitaires_inf3500_pkg is
  ...
  -- réfèrence : https://en.wikipedia.org/wiki/Base64
  ...
  -- on choisit arbitrairement de prendre les lettres minuscules 'a' `a 'f'
  --
  ------------------------------------------------------------------------------------------------
  ...
  ------------------------------------------------------------------------------------------------
  --
  -- retourne le nombre de bit nécessaire pour indexer un vecteur de taille n
  --
  ------------------------------------------------------------------------------------------------
