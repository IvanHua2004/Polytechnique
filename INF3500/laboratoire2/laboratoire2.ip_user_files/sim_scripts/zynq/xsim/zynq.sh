...
#
# Script generated by Vivado on Wed Oct 15 13:38:31 -0400 2025
...
# set xvlog options
xvlog_opts="--incr --relax  -L axi_vip_v1_1_21 -L processing_system7_vip_v1_0_23 -L xilinx_vip"

# set xvhdl options
xvhdl_opts="--incr --relax "

# script info
echo -e "zynq.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_lite_ipif_v3_0_4 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_37 -L proc_sys_reset_v5_0_17 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot zynq xil_defaultlib.zynq xil_defaultlib.glbl -log elaborate.log
}
