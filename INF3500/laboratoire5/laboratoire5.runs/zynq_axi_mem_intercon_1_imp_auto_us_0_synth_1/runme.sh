...
HD_PWD='C:/Users/yogio/OneDrive/Desktop/INF3500/laboratoire5/laboratoire5.runs/zynq_axi_mem_intercon_1_imp_auto_us_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_axi_mem_intercon_1_imp_auto_us_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_axi_mem_intercon_1_imp_auto_us_0.tcl
