...
#
# Script generated by Vivado on Sun Nov 30 17:27:12 -0500 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L proc_sys_reset_v5_0_17 -L axi_datamover_v5_1_37 -L axi_sg_v4_1_21 -L axi_dma_v7_1_36 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot zynq xil_defaultlib.zynq xil_defaultlib.glbl -log elaborate.log
}
