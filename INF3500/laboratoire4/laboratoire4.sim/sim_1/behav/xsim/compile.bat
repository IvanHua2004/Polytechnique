...
REM
REM Generated by Vivado on Mon Nov 17 21:23:24 -0500 2025
...
echo "xvhdl --incr --relax -prj PolyRISC_tb_vhdl.prj"
call xvhdl  --incr --relax -prj PolyRISC_tb_vhdl.prj -log xvhdl.log
